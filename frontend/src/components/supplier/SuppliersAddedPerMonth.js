...
function SuppliersAddedPerMonth(props) {
  ...
  //*********************************************CONSTANTS************************************************************* */
    ...
    suppliers?.forEach( supplier => {
        if(new Date().getUTCFullYear() === new Date(supplier.contractDate).getUTCFullYear()){
            var month = new Date(supplier.contractDate).getMonth();
            chartData[month]++;
        }
    });
...
export default SuppliersAddedPerMonth;